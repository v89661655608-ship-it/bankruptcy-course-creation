    ...
    <section id="support" className="py-20 bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50">
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <Card className="border-2 border-purple-200 shadow-xl hover:shadow-2xl transition-all w-full max-w-sm mx-auto md:max-w-none md:mx-0">
            <CardContent className="pt-8">
              ...
              <div className="bg-purple-50 border-2 border-purple-200 rounded-xl p-5 mb-6">
                ...
                <p className="text-sm text-muted-foreground">
                  Докупите чат отдельно за 3 999 ₽/мес или купите выгодный комбо курс+чат за 4 999 ₽ (экономия 900 ₽)
                </p>
              </div>
          ...
          <Card className="border-2 border-blue-200 shadow-xl hover:shadow-2xl transition-all bg-gradient-to-br from-blue-50 to-indigo-50 w-full max-w-sm mx-auto md:max-w-none md:mx-0">
            <CardContent className="pt-8">
              <div className="flex items-center gap-3 mb-6">
