  ...
  return (
    <section id="support" className="py-20 px-4 bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 gap-8 px-2 md:px-0 place-items-center md:place-items-stretch">
          <Card className="border-2 border-purple-200 shadow-xl hover:shadow-2xl transition-all w-full max-w-md md:max-w-none">
          ...
          <Card className="border-2 border-blue-200 shadow-xl hover:shadow-2xl transition-all bg-gradient-to-br from-blue-50 to-indigo-50 w-full max-w-md md:max-w-none">
            <CardContent className="pt-8">
              <div className="flex items-center gap-3 mb-6">
